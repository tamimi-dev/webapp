$.getJSON("https://spreadsheets.google.com/feeds/list/1fgjVhzrbqcCOP8Zls00BV--JsIXEenwWmMD2iF8X9VE/o7om10o/public/values?alt=json", function (data) {
      ...
      for (i = 0; i < sheetData.length; i++) {
		...
		var desc = data.feed.entry[i]['gsx$description']['$t'];
                ...
                document.getElementById('timel').innerHTML += ('<article class="timeline__item">'+'<h5 class="title title--h5 timeline__title">'+cose+'<span class="badge badge-pill badge-danger">'+loc+'</span>'+'</h5>'+'<span class="timeline__period">'+time+'</span>'+'<p class="timeline__description">'+desc+'</p>'+'</article>');
      }
    });
